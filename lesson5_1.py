...
N = int(input(
    'Введите кол-во предприятий для теста. Их значения поквартальной прибыли будут сгенерированы автоматически: '))
enterprises = []
total_sum = 0
for i in range(N):
    ne = New_Enterprise('A' + str(i), random.randint(500, 999), random.randint(500, 999), random.randint(500, 999),
